# try some Kuhn ch3 preprocessing code 2020.3.30
...
histogram(~segTrainTrans$AvgIntenCh1,
          xlab = "Transformed Data AvgIntenCh1",
          type = "count")
histogram(~segTrainTrans$EntropyIntenCh1,
          xlab = "Transformed Data EntropyIntenCh1",
          type = "count")
